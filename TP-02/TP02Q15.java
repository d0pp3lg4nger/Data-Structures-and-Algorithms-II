...
╚══════╝╚══════╝   ╚═╝      ╚═╝   ╚══════╝╚═╝  ╚═╝╚══════╝    ╚═════╝       ╚═════╝ ╚══════╝   ╚═╝      ╚═╝   ╚══════╝╚═╝  ╚═╝╚══════╝
    ...
    public void read(String line) throws Exception {
        String[] info = TP02Q15.cutter(';', line);

        setId(info[0]);
        setName(info[1]);

        // alternate names
        String tmp = TP02Q15.shambles("[", "", info[2]);
        tmp = TP02Q15.shambles("]", "", tmp);
        String[] alternateNamesArray = TP02Q15.cutter(',', tmp);

        for (int i = 0; i < alternateNamesArray.length; i++) {
            String alternateSTR = alternateNamesArray[i].trim();
            alternateSTR = TP02Q15.shambles("'", "", alternateSTR);
        ...
        // alternate actors
        String tmp2 = TP02Q15.shambles("[", "", info[11]);
        tmp2 = TP02Q15.shambles("]", "", tmp2);
        String[] alternateActorsArray = TP02Q15.cutter(',', tmp2);
    ...
    public void print(Lista personagens, String id) {
        ...
        if (personagem.getDateOfBirth() != null) {
            ...
            String[] dateCut = TP02Q15.cutter('-', date);
            date = dateCut[2];
            date += "-";
            date += dateCut[1];
            date += "-";
    ...
    // ------------- Pesquisa Sequencial ---------------------
    public void selection(String[] id, Lista personagens, int k) {
        setCountComp(0);
        setCountMov(0);
        for (int x = 0; id[x] != null && k > 0; x++, k--) {
            int smaller = x;
...
public class TP02Q15 {
    ...
    public static void main(String[] args) {
        ...
        personagem.selection(idArray, personagens, 10);
